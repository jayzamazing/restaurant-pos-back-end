 ...
 */
Restaurant.prototype.getRestaurantData = function() {
    var context = this;
        ...
        fs.readFile('dinnerdata.json', 'utf8', function(err, data) {
            ...
            if (err) {
                ...
                ph.promiseAllLogging([
                    context.addMenuItems(jsonData['menu items']),
                    context.addStateTax(jsonData['state tax']),
                    context.addTip(jsonData['recommended tip'])
                ]);
                resolve(jsonData);
            }
        });
